                    ...
                    <div className="flex flex-col mb-5 lg:mb-0 gap-y-4 lg:w-[50%]">
                        <div className="flex">
                            <div className="flex items-center mb-4 me-3">
                                ...
                                <label htmlFor="credit" className="ml-[5px] md:ml-2 text-[12px] md:text-[13px] lg:text-[14px] text-gray-500">Credit/Debit/ATM Card</label>
                            </div>
                        ...
                        <div className="flex items-center">
                            <Switch /> 
                            <p className="ml-[5px] md:ml-2 text-[12px] md:text-[14px] text-gray-500">Save card for future billing?</p>
                        </div>
                        
                    </div>
                    <div className="flex flex-col gap-y-4 lg:w-[50%] mt-2 lg:mt-0">
                        <p className="text-gray-600 font-semibold text-[14px] md:text-[15px] lg:text-[16px]">My cards</p>
                        <div className="flex flex-col bg-gray-100 px-4 py-4 rounded-md">
                            <div className="flex justify-between flex-col md:flex-row">
                                <div>
                                    ...
                                    <div>
                                        <p className="text-gray-600 mt-1 font-semibold text-[13px] md:text-[14px] lg:text-[15px]">Tom McBride</p>
                                        <p className="text-gray-400 mt-1 font-semibold text-[12px] md:text-[12px] lg:text-[13px]">**** *** **** 9865</p>
                                    </div>
                                </div>
                                <div className="flex flex-col flex-col-reverse md:flex-col">
                                    <div className="flex">
                                        <button className='w-max mr-3 py-[0.3rem] px-[1.1rem] md:px-[1.5rem] bg-gray-100 border border-primary-1 rounded-[8px] flex items-center justify-center gap-2 hover:bg-purple-100 hover:opacity-90 transition-all ease-in-out duration-300 group'>
                                            <span className='leading-[28px] tracking-[0.15px] text-primary-1 text-[13px] md:text-[14px] lg:text-[16px]'>EDIT</span>
                                        </button>
                                        <button className='w-max py-[0.3rem] px-[1.1rem] md:px-[1.5rem] border border-gray-200 bg-gray-100 text-gray-500 rounded-[8px] flex items-center justify-center gap-2 hover:bg-gray-200 hover:opacity-90 transition-all ease-in-out duration-300 group'>
                                            <span className='leading-[28px] tracking-[0.15px] text-[13px] md:text-[14px] lg:text-[16px]'>DELETE</span>
                                        </button>
                                    </div>
                                    <div className="flex mb-3 md:mb-0  md:justify-end mt-1">
                                        <p className="text-gray-400 mt-1 font-semibold text-[12px] md:text-[12px] lg:text-[13px]">Card expires at 12/24</p>
                                    </div>
                                </div>
                            </div>
