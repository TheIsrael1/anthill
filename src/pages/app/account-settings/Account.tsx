          ...
          <div className='flex mt-3 md:mt-0 flex-col gap-y-2'>
            <div className='flex gap-x-2 md:gap-x-4'>
              <Label
                htmlFor='file-input'
                role='button'
                className='w-max py-[0.3rem] px-[1.1rem] md:px-[1.5rem] bg-primary-1 rounded-[8px] flex items-center justify-center gap-2 hover:opacity-90 transition-opacity ease-in-out duration-300 group'
              >
              ...
              <button className='w-max py-[0.3rem] px-[1.1rem] md:px-[1.5rem] border border-red-200 bg-white text-red-500 rounded-[8px] flex items-center justify-center gap-2 hover:bg-red-100 hover:opacity-90 transition-all ease-in-out duration-300 group'>
                <span
                  className='leading-[28px] tracking-[0.15px] text-[13px] md:text-[14px] lg:text-[16px]'
        ...
        <div className='w-full mt-10 flex flex-col gap-y-3 md:gap-y-5'>
          ...
          <div className='flex w-full gap-x-4 mt-2'>
            ...
            <button className='w-max py-[0.3rem] px-[1.1rem] md:px-[1.5rem] border border-gray-200 bg-white text-gray-500 rounded-[8px] flex items-center justify-center gap-2 hover:bg-gray-100 hover:opacity-90 transition-all ease-in-out duration-300 group'>
              <span className='leading-[28px] tracking-[0.15px] text-gray-500 text-[13px] md:text-[14px] lg:text-[16px]'>
                CANCEL
              </span>
            </button>
          </div>
        ...
        <button
          className={`${
            disabled
              ...
              : 'border border-gray-200 bg-white text-gray-500 hover:bg-gray-100 hover:opacity-90 transition-all ease-in-out duration-300 group'
          } w-max mt-4 py-[0.3rem] px-[1.1rem] md:px-[1.5rem]  rounded-[8px] flex items-center justify-center gap-2`}
          disabled={disabled}
        >
          <span
            className='leading-[28px] tracking-[0.15px]
